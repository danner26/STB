...
describe('Article CRUD tests', function () {
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/listings')
          ...
          .end(function (articleSaveErr, articleSaveRes) {
            ...
            agent.put('/api/listings/' + articleSaveRes.body._id)
              .send(article)
              .expect(200)
  ...
  it('should be able to get a single article if not signed in', function (done) {
    ...
    // Save the article
    articleObj.save(function () {
      request(app).get('/api/listings/' + articleObj._id)
        .end(function (req, res) {
          // Set assertion
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/listings')
          ...
          .end(function (articleSaveErr, articleSaveRes) {
            ...
            agent.delete('/api/listings/' + articleSaveRes.body._id)
              .send(article)
              .expect(200)
  ...
  it('should not be able to delete an article if not signed in', function (done) {
    ...
    articleObj.save(function () {
      ...
      request(app).delete('/api/listings/' + articleObj._id)
        .expect(403)
        .end(function (articleDeleteErr, articleDeleteRes) {
          // Set message assertion
